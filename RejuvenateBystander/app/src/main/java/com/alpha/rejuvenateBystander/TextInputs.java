...
public class TextInputs extends AppCompatActivity {
            ...
            public void onClick(View view) {
                if (counter < limit - 1) {
                   ...
                   //Send API to Sentiment Analysis
                    ...
                    if (val > 0.19 && val < 0.5) {
                        Intent I = new Intent(TextInputs.this, FurtherQ.class);
                        I.putExtra("val", val);
                        startActivity(I);
                    }
                    //the result is comparitively positive
                    else {
                        Toast.makeText(TextInputs.this, "Thank you for answering!!", Toast.LENGTH_SHORT).show();
                        Intent I = new Intent(TextInputs.this, SumUp.class);
